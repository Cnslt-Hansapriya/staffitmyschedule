				...
				"mrs.resourcemanagement.ZMRS_SCHEDULE.view.myschedule.MyScheduleCustom",
				{
														...
														function(D) {
															...
															for (var i = 0; i < s.length; i++) {
																var o = s[i].record
																		.getBindingContext();
																o.oModel
																		.getProperty(o.sPath).duration = s[i].duration
																		+ o.oModel
																				.getProperty(o.sPath).DurationUnit;
																t = t
																		+ parseFloat(s[i].duration);
																I
																		.push(o.oModel
																				.getProperty(o.sPath));
															}
					...
					onPopoverEditPress : function(e) {
						...
						if (l.getData().AssignmentType !== "O") {
							...
							var s = "/CandidateSet(RequestNumber='" + r
									+ "',RoleNumber='" + R + "',ConsultantID='"
									+ C + "')";
					...
					loadAssignmentsForDateRange : function(s, e) {
						...
						// = mrs.resourcemanagement.Util.Util.getCurrentUser();
						if (this._Parameter) {
							var p = "/PersonSet('" + this._Parameter
									+ "')/AssignmentSet";
